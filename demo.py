...
from pysjtu import AsyncSession, Client, CourseRange, NNRecognizer
...
async def main():
    ...
    async with AsyncSession(session_file=sess_file) if sess_file else AsyncSession(username=os.environ["SJTU_USER"],
